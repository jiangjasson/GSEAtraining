...
Gene ID conversion is a very common task in gene set enrichment analysis.
...
In the **GSEAtopics** package, there is a `map_to_entrez_id()` which generates a global mapping
