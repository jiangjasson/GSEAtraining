...
genes = map[genes]; genes = unname(genes[!is.na(genes)])
universe = map[universe]; universe = unname(universe[!is.na(universe)])
```
...
Question: can you also integrate the centralities into the standard GSEA method?
